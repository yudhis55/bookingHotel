        ...
        <div class="row">
          <div class="col-md-12 col-sm-12">
            ...
            try {
              ...
              // Menyiapkan query SELECT untuk mendapatkan data transaksi berdasarkan ID pengguna dan status pembayaran "complete"
              $stmt = $dbh->prepare("SELECT * FROM transaksi WHERE id = ? AND statusPembayaran = 'complete'");
