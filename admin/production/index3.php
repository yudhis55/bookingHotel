      ...
      <div class="right_col" role="main">
        <div class="row">
          <div class="col-md-12 col-sm-12 ">
            <h3>List of room</h3>
            <hr>
            <a href="/bookingHotel/admin/production/create.php" class="btn btn-primary" role="button">Add Room</a>
            <br>
            <table class="table">
              <thead>
                <tr>
              ...
              <tbody>
                ...
                while ($row = $result->fetch()) {
                  ...
                  <tr>
                    ...
                    <td>$row[status]</td>
                  <td>
                    <a href='/bookingHotel/admin/production/edit.php?noKamar=$row[noKamar]' class='btn btn-primary btn-sm'>Edit</a>
                    <a href='/bookingHotel/admin/production/delete.php?noKamar=$row[noKamar]' class='btn btn-danger btn-sm'>Delete</a>
                  </td>
                </tr>";
                }
                ?>
