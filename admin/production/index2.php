      ...
      <div class="right_col" role="main">
        <div class="row">
          <div class="col-md-12 col-sm-12 ">
            <h3>List of user</h3>
            <hr>
            <a href="/bookingHotel/admin/production/createUser.php" class="btn btn-primary" role="button">Add Admin</a>
            <br>
            <table class="table">
              <thead>
                <tr>
              ...
              <tbody>
                ...
                while ($row = $result->fetch()) {
                  ...
                  <tr>
                    ...
                    <td>$row[userRole]</td>
                  <td>
                    <a href='/bookingHotel/admin/production/editUser.php?id=$row[id]' class='btn btn-primary btn-sm'>Edit</a>
                    <a href='/bookingHotel/admin/production/deleteUser.php?id=$row[id]' class='btn btn-danger btn-sm'>Delete</a>
                  </td>
                </tr>";
                }
                ?>
